...
const NavbarSticky = () => {
    ...
    <>
      {user ? (
        <Menu>
          ...
          <MenuList className="bg-[#070719] text-white hover:bg-pink-600">
  ...
  return (
    <Navbar className="fixed top-0 z-50 h-max max-w-screen-xl mx-auto rounded-none px-4 py-2 lg:px-8 lg:py-4">
      ...
      <MobileNav open={openNav}>
        <div>{navList}</div>
        <div>
          <div className="flex items-center gap-x-1">{authenticationManu}</div>
        </div>
      </MobileNav>
    </Navbar>
  );
